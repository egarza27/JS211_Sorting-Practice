...
const stringsToNumbs = strNums.map((str) => {
...
const sumEvens = (arr) =>
  arr.filter((num) => num % 2 === 0).reduce((a, b) => a + b);

console.log(sumEvens(stringsToNumbs));
...
const weatherStates = [...new Set(weather.map((id) => id.weather_state_name))];
console.log(weatherStates);

//find the id of the object in weather that has a min_temp of 15.915

const idealTemp = weather.filter(function (id) {
  return id.min_temp === 15.915;
});
